...
def add_series():
    ...
    if request.method == 'POST':
        try:
            ...
            cursor.execute(series_qurry,series_value) 
            print(series_id,Sname,Sdecc,Saccess,Slanguage,Scat,Sststus,Sseasons,Sepisodes,Syear,Sdate,Srating,seo_title,seo_desc,seo_keyword,thumb_file,poster_file,Strailer)
